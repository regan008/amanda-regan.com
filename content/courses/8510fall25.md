...
* **Reading, Tutorials, or Videos (to be completed before class):**
    ...
    * If you haven't already, please download and install the following:    
        * Download Python
            * To check to see if its already installed on your machine type ```which python3```.
            * Use the commands above to verify your installation worked.
            * If you don't have python installed, you can install it using homebrew. (Mac OS only)
                * ```brew install python3```
            * Linux users can use their package manager to install python.
            * Windows users should use the official installer from [python.org.]((https://www.python.org/downloads/))
...
* **Build SQL Queries** {{< badge text="Tech Table Mini-Assignment" color="terracotta" />}}
...
##### Mon, Oct 27
* **Topic:**
   * Sentence Transformers for Semantic Similarity and Text Reuse Detection (catch up from last week)
...
* **Due:** 
    * Questions to Slack by 10am
* **Computer Vision or Advanced Text Analysis Project & Analysis (20%):** {{< badge text="Project" color="teal" />}} 
...
##### Mon, Nov 24
* No class - work on your final visualization project.
...
* **Due:** 
    * Questions to Slack by 10am
* **Visualization Project & Analysis (20%):** {{< badge text="Project" color="teal" />}} 
    ...
    * You must discuss your concept for approval before development and include user documentation.
    * Due Tues, Dec 9 by 7pm.


##### Tue, Dec 9 7-9pm
* Final Exam Period.
* Showcase of Data Visualization Apps and Projects
* Final Reflection Due Sun, Dec 14th by 11:59pm.
