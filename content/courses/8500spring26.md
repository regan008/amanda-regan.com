...
This course will proceed in roughly 3 units. In the first unit students will learn to navigate their computer using the command line, learn file system structure and basic server architecture, and will learn how to use GitHub to ensure reproducible datasets and code. The second unit focuses on the basics of programming with an emphasis on computational thinking skills and the foundational patterns behind every programming language. In the final unit, we will survey various methods within computational history. We will explore creating static visualizations, basic text analysis, topic modeling, and mapping. Throughout we will ask ourselves: what kinds of historical questions do these methods make possible? Students will also build a personal website and portfolio using the static site generator Hugo to showcase their work from the semester.
...
* Understand how to employ basic computational methodologies like text analysis, topic modeling, and data manipulation. 
...
|---|---|
|Worksheets and Other Coding Assignments      | 45%  |
|Portfolio and Digital Presence   | 15%  |
|Participation, Coding Logs, & Weekly Tech Table Questions   | 20%  |
|Dataset and Method Proposal (Final Project) | 20%|



* **Worksheets and Other Weekly Coding Assignments (45%):** Most weeks you will complete a worksheet that is based on the method for the week. With a few exceptions, these worksheets will be due the week after we discuss that method. Worksheets will be Quatro documents that blend code and prose. In these worksheets you'll be asked to practice various concepts with a provided dataset. These worksheets will contain a mix of problems ranging from easy to very hard. There is not an answer key that I'll grade from and many questions will have multiple ways to answer the question. The goal here is to *practice the methodology at hand.* It's one thing to read about the methodology and read the documentation for the associated R packages, but it's another thing to actually apply that methodology to historical sources and ask questions of it. So, in other words, the goal of these worksheets is twofold. First, it is to grasp the basic programming concepts related to the methodology. Second, it is to understand what types of historical questions can be asked of that method and what kinds of arguments or interpretations it makes possible. There are a total of nine worksheets across the semester and I will provide supplementary coding assignments when a worksheet is not due. Worksheets are listed in the schedule on the day they are due. Note that in all cases they are due **before the start of class**. 
  * [#1: R Basics](https://github.com/regan008/8500-Worksheets/blob/main/1-RBasics.qmd) Due Feb 2nd by 4pm.
  * [#2: Data Structures](https://github.com/regan008/8500-Worksheets/blob/main/2-DataStructures.qmd) Due Feb 9th by 4pm.
  * [#3: Loops, Conditionals, and Functions](#) Due Feb 16th by 4pm.
  * [#4: Basic Data Manipulation](#) Due March 2nd by 4pm.
  * [#5: Advanced Data Manipulation](#) Due March 9th by 4pm.
  * [#6: Data Visualization](#) Due April 6th by 4pm.
  * [#7: Text Analysis](https://github.com/regan008/8500-Worksheets/blob/main/5-TextAnalysis.qmd) Due April 13th by 4pm.
  * [#8: Topic Modeling](https://github.com/regan008/8500-Worksheets/blob/main/6-TopicModeling.qmd) Due April 20th by 4pm.
  * [#9: Mapping](https://github.com/regan008/8500-Worksheets/blob/main/7-Mapping.qmd) Due Finals Week.
* **Portfolio and Digital Presence (15%):** To build a successful digital history project, its necessary to communicate findings via the web. Therefore students will need to know a baselevel of website design. In this class we will learn to build sites using the static site generator Hugo. We will spend time learning this technology and then students will work on their own, over the remainder of the semester to build a digital website and portfolio for themselves using this technology. 
* **Participation, Coding Logs, & Weekly Tech Table Questions (20%):**
  * Each Wednesday is a "Tech Table" - a student-driven troubleshooting session where we work through challenges with the week's assignment. Students must make a reasonable start on assignments before class and submit questions to Slack by 10am.
  * It is essential that students attend class regularly and are active participants. Missing one class is like missing a link in a chain. Concepts in class scaffold and build on one another throughout the semester. Missing one class will make future classes more difficult. If you are sick and contagious, please do not come to class. A zoom link will be provided if necessary but students should make every attempt to attend in person.
  * Each Monday you will submit a structured coding log (markdown template provided on Canvas) documenting 2 significant challenges you encountered, your problem-solving process, resources consulted, and what you learned. Weeks 1-9: Document problem-solving using course materials, documentation, and non-AI resources. Weeks 10-Finals: Continue the same format but also document whether and how you used AI tools for each challenge, including your evaluation of AI-generated code.
* **Dataset Proposal (20%):** At the conclusion of the semester each of you will write a dataset proposal for a digital history project. Further details will be provided in class but students should think about the process of creating a dataset and the decisions that are involved in building one. This assignment will ask you to take a body of historical sources and think about how it might be turned into a dataset that you would use a digital method to analyze. Students should address questions like: What historical question is the dataset centered around? What is the dataset based on? What information will be captured and how will it be stored? Will you be importing external data? (i.e. Historical place names from an existing dataset or information about a person's term in office.) If so, where will that information come from? Who owns it? What are the methods behind the data collection design and process? Further details and guidelines will be provided in class.
...
#### Unit 1: Foundations and Infrastructure
...
##### Wed., Jan. 21
* **Topic:**
  * Tech Table: GitHub and Command Line
* **Due:**
  * Questions to Slack by 10am
  * GitHub and Terminal Assignment Due by 4pm

---

#### Unit 2: Programming Fundamentals (in R)

##### Mon., Jan. 26
* **Topic:**
  * Introduction to R in VS Code and Quarto 
* **Reading, Tutorials, and Videos (to be completed before class):**
...
* **Reading, Tutorials, and Videos (to be completed before class):**
  * Bruno Rodrigues, [Chapter 2: Objects, types and useful R functions to get started](https://modern-rstats.eu/objects-types-and-useful-r-functions-to-get-started.html)
* **Due**
  * Worksheet 1: R Basics due by 4pm to canvas
...
* **Reading, Tutorials, and Videos (to be completed before class):**
* **Due:**
  * Worksheet 2: Data Structures due by 4pm to canvas
...
##### Mon., Feb. 16
* **Topic:**
  * Information as Data, Tidy Data Principles
* **Reading, Tutorials, and Videos (to be completed before class):**
...
* **Due:**
  * Worksheet 3: Loops, Conditionals and Functions due by 4pm to canvas
...
* **Due:**
  * GitHub Questions to Slack by 10am
  * A reasonable start on Worksheet 4
...
* **Reading, Tutorials, and Videos (to be completed before class):**
* **Due:**
  * Worksheet 4: Basic Data Manipulation due by 4pm to canvas
...
* **Due:**
  * GitHub Questions to Slack by 10am
  * A reasonable start on worksheet 5
...
* **Reading, Tutorials, and Videos (to be completed before class):**
  * TBD
* **Due:**
  * Worksheet 5: Advanced Data Manipulation due by 4pm to canvas

##### Wed., Mar. 11
* **Topic:**
  * Hugo: Static Site Generators, Setup, Installation, Structure, Theming
* **Reading, Tutorials, and Videos (to be completed before class):**
  * Hugo Documentation:
...
##### Mon., Mar. 23
* **Topic**
 * Hugo: Templating, Content, Deployment, Polish
...
##### Mon., Mar. 30
* **Topic:**
  * Data Visualization with ggplot and the Grammar of Graphics
* **Reading, Tutorials, and Videos (to be completed before class):**
...
* **Due:**
  * GitHub Questions to Slack by 10am
  * A reasonable start on Worksheet 6
...
* **Due:**
  * Worksheet 6: Data Visualization due by 4pm to canvas
...
* **Due:**
  * GitHub Questions to Slack by 10am
  * Reasonable start on Worksheet 7
...
* **Due:**
  * Worksheet 7: Text Analysis due by 4pm to canvas
...
* **Due:**
  * GitHub Questions to Slack by 10am
  * Reasonable Start on Worksheet 8: Topic Modeling
...
* **Due:**
  * Worksheet 8: Topic Modeling due by 4pm to canvas
...
* **Due:**
  * GitHub Questions to Slack by 10am
  * Reasonable Start on Worksheet 9: Mapping
...
##### Aritificial Intelligence (AI) Use Policy
All students in the Digital History Ph.D. program are bound by the program's AI Use Policy (found in the [Ph.D. program handbook](https://clemson.box.com/s/21yo2g36lga7s5wvtqmmptcnlh47su0x) on pg 10). This course policy is designed to align with and support those program-wide guidelines. In weeks 1-9, AI tools are strictly prohibited. During the first half of the semester, you must develop foundational computational thinking skills without AI assistance. Any use of AI coding tools (ChatGPT, Claude, GitHub Copilot, etc.) during weeks 1-9 or before the instructor gives explicit permission, will result in automatic failure of the assignment and will be reported as an academic integrity violation. You must learn to think computationally and understand programming logic before you can effectively use AI tools.

Beginning in Week 10, the instructor will grant permission and introduce guiderails for the use of AI tools for coding. Once introduced to AI coding tools, you may use them to help understand code structure, debug errors, and improve your technical skills. However, you must understand every line of code you submit, verify that AI-generated code produces accurate results, and document your AI use in your weekly coding log. AI use is strictly forbidden for any historical analysis, interpretation, or writing. Assignments and worksheets in this course require you to apply historical knowledge and analytical skills. Any use of AI to generate historical analysis, interpret data results, answer interpretive questions, or write historical arguments will be treated as plagiarism and academic dishonesty per the program's AI policy. Remember: AI should help you learn coding, not replace your learning or your historical thinking. Always be the historian in the loop—use AI as a tool to enhance your technical skills, not as a substitute for engaging with course materials or developing your own historical and analytical abilities.
