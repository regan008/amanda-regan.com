...
* **Assignments:**
    * Create a GitHub repository for your class worksheets. Share the link to your repository on Slack and upload it to canvas. 
        * Be sure that your repository includes a `Readme.md` file that explains what the repo contains (or will contain). 
...
* **Assignment:**
	* Create a dataset: Using the principles of Tidy Data create a well structured csv file before class. You should use either a primary source dataset that you have already, or one of the primary source sets linked below.
    * Complete the Data Structures (focuses on data structures, functions, and loops).
